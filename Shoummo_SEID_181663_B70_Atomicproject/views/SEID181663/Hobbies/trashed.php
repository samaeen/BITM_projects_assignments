...
if (isset($_REQUEST['byHobbies'])) {
    $_SESSION["byHobbies"] = $_REQUEST['byHobbies'];
}
...
<div>
    ...
    <div  class="container">
        ...
        <div style="margin-left: 60%; height: 80px;">
            ...
            <script type="text/javascript">
                function checkForm(form) {
                    if(!form.byHobbies.checked && !form.byName.checked){
                        alert("Please select atleast one search catagory");
                        form.byHobbies.focus();
                        form.byName.focus();
                        return false;
                    }
                    return true;
            ...
            <form id="searchForm" action="trashed.php"  method="get" style="margin-top: 5px; margin-bottom: 10px " onsubmit="return checkForm(this);">
                ...
                <input type="checkbox"  name="byHobbies"   checked  >By Hobbies
        ...
        <form id="multiple"  method="post">
            ...
            <div class="bg-default text-center"><h4><u>Hobbies info - Trash list</u></h4></div>
