...
{
    printf("Here is your required info: [<strong>Person ID: </strong>%s, <strong>Name: </strong>%s, <strong>Gender: </strong>%s]",$singleItem->id,$singleItem->name,$singleItem->gender);
