...
if (isset($_REQUEST['byGender'])) {
    $_SESSION["byGender"] = $_REQUEST['byGender'];
}
...
<div>
    ...
    <div  class="container">
        ...
        <div style="margin-left: 60%; height: 80px;">
            ...
            <script type="text/javascript">
                function checkForm(form) {
                    if(!form.byGender.checked && !form.byName.checked){
        ...
        <form id="multiple"  method="post">
            ...
            <div class="bg-default text-center"><h4><u>Gender info - Trash list</u></h4></div>
