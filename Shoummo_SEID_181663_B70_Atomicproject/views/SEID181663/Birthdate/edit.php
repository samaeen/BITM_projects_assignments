...
<div class="container bg-default" style="margin-top: 100px">
    ...
    <h1 style="text-align: center"> Birthdate - Edit Form </h1>
    ...
    <div class="col-md-8" style="margin-top: 50px; margin-bottom: 50px">
        ...
        <form action="update.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="birthdate" value="<?php echo $oneData->birthdate ?>" pattern="[a-zA-Z0-9!#$%&amp;'*+/\=^_`{|}~.-]+@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*" class="form-control" name="Name" placeholder="Please Enter Your Birthdate">
            </div>
