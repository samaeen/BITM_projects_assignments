...
if(isset($_REQUEST['search']) ) {
    $someData = $obj->trashedsearch($_REQUEST);
    $allData = $someData;
    $serial = 1;
}
...
<div  class="container">
    ...
    <div style="margin-left: 70%">
        <form id="searchForm" action="trashed.php"  method="get" style="margin-top: 5px; margin-bottom: 10px ">
    ...
    <div class="bg-default text-center"><h4><u>Email - Trash list</u></h4></div>
                ...
                echo "
                                  ...
                                  <tr  style='background-color: $bgColor'>
                                     ...
                                     <td>
                                       ...
                                       <a href='delete.php?id=$oneData->id'  onclick='return doConfirm()' class='btn-default'>Delete</a>
