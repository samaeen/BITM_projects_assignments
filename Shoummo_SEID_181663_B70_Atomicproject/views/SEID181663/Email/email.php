...
if(!isset($_REQUEST['id'])) {
    $list = 1;
    $recordSet = $email->index();

}
else {
    $list= 0;
    $email->setData($_REQUEST);
...
$sl=0;
    ...
    printf("<table><tr> <td width='50'><strong>Serial</strong></td><td width='50'><strong>ID</strong></td><td width='250'><strong>Name</strong></td><td width='250'><strong>Email</strong></td></tr>");
    ...
    $sl++;
    printf("<tr><td width='50'>%d</td><td width='50'>%d</td><td width='250'>%s</td><td width='250'>%s</td></tr>",$sl,$id,$name,$email);
...
{
    printf("Here is your required info: [<strong>Person ID: </strong>%s, <strong>Name: </strong>%s, <strong>Email: </strong>%s]",$singleItem->id,$singleItem->name,$singleItem->email);
