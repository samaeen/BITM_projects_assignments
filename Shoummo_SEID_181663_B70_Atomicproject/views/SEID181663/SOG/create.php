    ...
    <div class="col-md-8" style="margin-top: 50px; margin-bottom: 50px">
        ...
        <form action="store.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="Name" placeholder="Please Enter Organization Name" required>
            </div>

            <div class="input-group">
                <label for="SOG">Summary</label>
                <textarea class="form-control" rows="15" cols="100" name="SOG" placeholder="Write Summary" required></textarea>
            </div>
