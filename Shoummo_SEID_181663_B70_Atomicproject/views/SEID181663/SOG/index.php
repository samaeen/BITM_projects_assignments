...
if (isset($_REQUEST['bySOG'])) {
    $_SESSION["bySOG"] = $_REQUEST['bySOG'];
}
...
<div  class="container">
    ...
    <div style="margin-left: 60%; height: 80px;">
        ...
        <script type="text/javascript">
            function checkForm(form) {
                if(!form.bySOG.checked && !form.byName.checked){
        ...
        <form id="searchForm" action="index.php"  method="get" style="margin-top: 5px; margin-bottom: 10px " onsubmit="return checkForm(this);">
            ...
            <input type="checkbox"  name="bySOG"   checked  >By Summary
    ...
    <form id="multiple"  method="post">
        ...
        <div class="bg-default text-center"><h4>Summary of Organization - Active list</h4></div>
