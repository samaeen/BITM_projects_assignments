...
if($list){
    ...
    printf("<table><tr> <td width='50'><strong>Serial</strong></td><td width='50'><strong>ID</strong></td><td width='250'><strong>Name</strong></td><td width='250'><strong>Birthdate</strong></td></tr>");
    ...
    foreach($recordSet as $row) {
        ...
        $sl++;
        printf("<tr><td width='50'>%d</td><td width='50'>%d</td><td width='250'>%s</td><td width='250'>%s</td></tr>",$sl,$id,$name,$birthdate);
...
{
    printf("Here is your required info: [<strong>Person ID: </strong>%s, <strong>Name: </strong>%s, <strong>Birthdate: </strong>%s]",$singleItem->id,$singleItem->name,$singleItem->birthdate);
