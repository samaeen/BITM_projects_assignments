...
<?php
        $ref=$_SERVER['HTTP_REFERER'];
         ...
         echo "
             ...
             <h4> Single Organization Information </h4>
             ...
             <table class='table table-bordered table-striped'>
                    ...
                    <tr>                   
                     ...
                     <tr>                   
                        <td>  <b>SOG</b>  </td>                
                        <td>  <b>$oneData->sog</b>  </td>                
                      
                    </tr>
                        
                    <tr>
                    <td class='text-center' colspan='2'>  <a class='btn bg-primary' href='$ref'> Back to List</a> </td>
                    </tr>
