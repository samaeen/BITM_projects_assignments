...
class Gender extends Database
{
    ...
    public function store(){
        ...
        $sqlQuery = "INSERT INTO gender (name, gender, is_trashed) VALUES (? , ?, ?)";
        $dataArray = [ $this->name, $this->gender, "NO" ];
    ...
    public function update(){
        ...
        $sqlQuery  = "UPDATE gender SET name=?, gender = ? WHERE id=".$this->id;
    ...
    public function trashedsearch($requestArray){
        $sql = "";
        if( isset($requestArray['byGender']) && isset($requestArray['byName']) )  $sql = "SELECT * FROM `gender` WHERE `is_trashed` <>'No' AND (`gender` LIKE '%".$requestArray['trashsearch']."%' OR `name` LIKE '%".$requestArray['trashsearch']."%')";
        if(isset($requestArray['byGender']) && !isset($requestArray['byName']) ) $sql = "SELECT * FROM `gender` WHERE `is_trashed` <>'No' AND `gender` LIKE '%".$requestArray['trashsearch']."%'";
        if(!isset($requestArray['byGender']) && isset($requestArray['byName']) )  $sql = "SELECT * FROM `gender` WHERE `is_trashed` <>'No' AND `name` LIKE '%".$requestArray['trashsearch']."%'";
    ...
    public function searchPaginator($page=1,$itemsPerPage=3,$requestArray){
        ...
        $sql = "";
        if( isset($requestArray['byGender']) && isset($requestArray['byName']) )  $sql = "SELECT * FROM `gender` WHERE `is_trashed` ='No' AND (`gender` LIKE '%".$requestArray['search']."%' OR `name` LIKE '%".$requestArray['search']."%') LIMIT $start,$itemsPerPage";
        if(isset($requestArray['byGender']) && !isset($requestArray['byName']) ) $sql = "SELECT * FROM `gender` WHERE `is_trashed` ='No' AND `gender` LIKE '%".$requestArray['search']."%' LIMIT $start,$itemsPerPage";
        if(!isset($requestArray['byGender']) && isset($requestArray['byName']) )  $sql = "SELECT * FROM `gender` WHERE `is_trashed` ='No' AND `name` LIKE '%".$requestArray['search']."%' LIMIT $start,$itemsPerPage";
    ...
    public function trashsearchPaginator($page=1,$itemsPerPage=3,$requestArray){
        ...
        $sql = "";
        if( isset($requestArray['byGender']) && isset($requestArray['byName']) )  $sql = "SELECT * FROM `gender` WHERE `is_trashed` <>'No' AND (`gender` LIKE '%".$requestArray['trashsearch']."%' OR `name` LIKE '%".$requestArray['trashsearch']."%') LIMIT $start,$itemsPerPage";
        if(isset($requestArray['byGender']) && !isset($requestArray['byName']) ) $sql = "SELECT * FROM `gender` WHERE `is_trashed` <>'No' AND `gender` LIKE '%".$requestArray['trashsearch']."%' LIMIT $start,$itemsPerPage";
        if(!isset($requestArray['byGender']) && isset($requestArray['byName']) )  $sql = "SELECT * FROM `gender` WHERE `is_trashed` <>'No' AND `name` LIKE '%".$requestArray['trashsearch']."%' LIMIT $start,$itemsPerPage";
