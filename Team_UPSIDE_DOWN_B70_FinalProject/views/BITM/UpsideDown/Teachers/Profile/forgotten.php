...
if(isset($_POST['email'])) {
    ...
    $singleTeachers =  $obj->setData($_POST)->view();



    $passwordResetLink= $singleTeachers->password ;
    ...
    $mail->setFrom($gmailAddress,'Teachers Management');
    $mail->addReplyTo($gmailAddress,"Teachers Management");
    $mail->Subject    = "Your Password Reset Link";
    $message =  "Please click this link to reset your password: 
       http://".$myHostIP."/Team_UPSIDE_DOWN_B70_FinalProject/views/BITM/UpsideDown/Teachers/Profile/resetpassword.php?email=".$_POST['email']."&code=".$singleTeachers->password;
